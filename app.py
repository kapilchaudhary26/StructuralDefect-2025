...
if st.button('Analyze Defects'):
    with st.spinner('Analyzing defects and generating report...'):
        ...
        * Provide the short terms nd long term solution for the repair along with an estimated cost in INR and estimated time of repair.
